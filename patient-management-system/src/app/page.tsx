        ...
        <div className="w-full min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-y-auto">
            ...
            <header className="bg-white/70 backdrop-blur-md shadow-sm sticky top-0 z-10">
              ...
              MediPanel
                    ...
                    <Link href="/login">
                        <button
                            className="bg-blue-600/90 backdrop-blur-sm text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                            Login
                        </button>
                    </Link>
                </nav>
                    ...
                    {features.map((feature, index) => (
                        <Card key={index}
                            ...
                            <CardContent className="p-6">
                                <div
                                    className="flex items-center justify-center h-12 w-12 rounded-md bg-blue-100/80 backdrop-blur-sm mx-auto">
                                    {feature.icon}
                                </div>
