...
export default function Error({
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-red-50 to-white p-4">
            {/* Background Pattern */}
            ...
            <Card className="w-full max-w-lg shadow-lg border-red-100 relative backdrop-blur-sm bg-white/80">
