...
import type {OffRecordMeds} from "@prisma/client";
...
import {getIssueData} from "@/app/lib/actions";
...
const PrescriptionIssue = async ({issueID}: { issueID: number }) => {
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-sm text-slate-500">
                            Drug: {issue.drug.name} • Brand: {issue.brand.name} • Quantity: {issue.quantity} • batchID: {issue.batch?.id || 'N/A'}
                        </div>
...
export {PrescriptionIssue, OffRecordMedsList};