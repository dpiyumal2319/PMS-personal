    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 p-4">
            <div className="flex items-center space-x-4">
                ...
                <Input type="text" name="presentingSymptoms" value={formData.presentingSymptoms} onChange={handleChange}
                       required/>
            </div>
            <div className="flex items-center space-x-4">
                ...
                {formData.issues.map((issue, index) => {
                    return (
                        <Card key={index} className="flex items-center space-x-4 p-4">
                            <Label className="w-1/3">Issue {index + 1}</Label>
                            <div className="flex items-center space-x-4">
                                <span>{issue.drugId}</span>
                                <span>{issue.brandId}</span>
