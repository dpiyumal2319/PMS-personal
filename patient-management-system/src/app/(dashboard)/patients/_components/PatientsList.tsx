...
export default async function PatientsList({patients}: { patients: Patient[] }) {
                ...
                patients.map((patient) => (
                    ...
                    >
                        ...
                        >
                            {/* Patient Name */}
                            <div
                                className={`flex items-center gap-4 font-semibold text-md flex-1 ${patient.gender === 'MALE' ? 'text-primary-600' : 'text-pink-600'}`}>
                        ...
                        {activeQueue && (
                            <div className="ml-6">
                                <AddToActiveQueueButton patientID={patient.id} queue={activeQueue}/>
                            </div>
                        )}
                    </Card>
                ))
