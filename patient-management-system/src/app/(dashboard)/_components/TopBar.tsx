...
export default function TopBar() {
    return (
        <div className={"h-14 bg-primary-500 flex items-center justify-between p-2 border-b-2 border-primary-900 shadow"}>
            <div className={"relative flex items-center gap-2 bg-primary-600 p-2 rounded"}>
